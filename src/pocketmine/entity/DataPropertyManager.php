...
class DataPropertyManager{
     ...
     * @return int|null
     */
    public function getByte(int $key){
     ...
     * @param bool $force
     */
    public function setByte(int $key, int $value, bool $force = false){
     ...
     * @return int|null
     */
    public function getShort(int $key){
     ...
     * @param bool $force
     */
    public function setShort(int $key, int $value, bool $force = false){
     ...
     * @return int|null
     */
    public function getInt(int $key){
     ...
     * @param bool $force
     */
    public function setInt(int $key, int $value, bool $force = false){
     ...
     * @return float|null
     */
    public function getFloat(int $key){
     ...
     * @param bool  $force
     */
    public function setFloat(int $key, float $value, bool $force = false){
     ...
     * @return null|string
     */
    public function getString(int $key){
     ...
     * @param bool   $force
     */
    public function setString(int $key, string $value, bool $force = false){
     ...
     * @return null|Vector3
     */
    public function getBlockPos(int $key){
     ...
     * @param bool         $force
     */
    public function setBlockPos(int $key, $value, bool $force = false){
     ...
     * @return int|null
     */
    public function getLong(int $key){
     ...
     * @param bool $force
     */
    public function setLong(int $key, int $value, bool $force = false){
     ...
     * @return null|Vector3
     */
    public function getVector3(int $key){
     ...
     * @param bool         $force
     */
    public function setVector3(int $key, $value, bool $force = false){
    ...
    private function checkType(int $key, int $type){
     ...
     * @param bool  $force
     */
    public function setPropertyValue(int $key, int $type, $value, bool $force = false){
        if(!$force){
            $this->checkType($key, $type);
        }
     ...
     */
    public function clearDirtyProperties(){
