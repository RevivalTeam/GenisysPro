...
abstract class BaseLevelProvider implements LevelProvider{
    ...
    public function loadChunk(int $chunkX, int $chunkZ, bool $create = false){
    ...
    public function saveChunk(Chunk $chunk){
    ...
    abstract protected function readChunk(int $chunkX, int $chunkZ);

    abstract protected function writeChunk(Chunk $chunk);
}