...
interface BlockIds {
	...
	const SIGN_POST = 63;
	const OAK_DOOR_BLOCK = 64, DOOR_BLOCK = 64, WOODEN_DOOR_BLOCK = 64, WOOD_DOOR_BLOCK = 64;
	const LADDER = 65;
	const RAIL = 66;
	...
	const CAKE_BLOCK = 92;
	const REPEATER_BLOCK = 93, UNPOWERED_REPEATER = 93, UNPOWERED_REPEATER_BLOCK = 93;
	...
	const SPRUCE_WOOD_STAIRS = 134, SPRUCE_WOODEN_STAIRS = 134, SPRUCE_STAIRS = 134;
	const BIRCH_WOOD_STAIRS = 135, BIRCH_WOODEN_STAIRS = 135, BIRCH_STAIRS = 135;
	const JUNGLE_WOOD_STAIRS = 136, JUNGLE_WOODEN_STAIRS = 136, JUNGLE_STAIRS = 136;
	...
	const STAINED_GLASS_PANE = 160, STAINED_GLASS_PANEL = 160;
	const LEAVES2 = 161;
	const WOOD2 = 162, TRUNK2 = 162, LOG2 = 162;
	const ACACIA_WOOD_STAIRS = 163, ACACIA_WOODEN_STAIRS = 163, ACACIA_STAIRS = 163;
	const DARK_OAK_WOOD_STAIRS = 164, DARK_OAK_WOODEN_STAIRS = 164, DARK_OAK_STAIRS = 164;
	...
	const DOUBLE_RED_SANDSTONE_SLAB = 181, DOUBLE_PURPUR_SLAB = 181;
